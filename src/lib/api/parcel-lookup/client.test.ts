...
import { lookupParcelByCadastralId } from "./client";
...
test("returns canonical Parcel shape from successful lookup", async () => {
  const mockParcel = {
    id: "C-78401:101:3143",
  ...
  const result = await lookupParcelByCadastralId("78401:101:3143");
